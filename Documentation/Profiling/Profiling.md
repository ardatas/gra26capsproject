...
The profiled binary's SIMD `julia` body is preserved unchanged as `julia_V2`, so the archived profiles are the baseline profile of V2 and of V0 before optimizations.
...
![Grayscale V0: julia has 99.99% of samples](archive/profile-2026-07-15_17-02-41-baseline-76ea4cbe5d5b/gray-v0-julia-99.99pct.png)
...
![Grayscale V0: active-mask region has 66.37% of samples](archive/profile-2026-07-15_17-02-41-baseline-76ea4cbe5d5b/gray-v0-mask-hotspot-66.37pct.png)
...
![Color V0: active-mask region has 52.77% of samples](archive/profile-2026-07-16-14-15-00-color/color-v0-mask-hotspot-52.77pct.png)
...
1. Run the correctness gate and require V0, V1, and V2 to be byte-identical to V3.
2. Compare the changed version with the V2 baseline using `benchmark.sh`.
