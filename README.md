...
- `Implementierung/Makefile`: Makefile für Ihre Implementierung, welches durch einen Aufruf von `make` Ihre Implementierung kompiliert. Die dadurch erzeugte Binary soll durch `make` im Ordner `Implementierung/` erstellt werden mit dem Namen `project`.
